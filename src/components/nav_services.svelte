<script lang="ts">
  ...
  let isServicesOpen: boolean = false;
</script>

<button
  type="button"
  class="inline-flex items-center text-sm font-semibold leading-6 text-white"
  aria-expanded="false"
  on:click={() => {
    ...
    >
      <div class="p-4">
        ...
        >
          ...
          <div>
            <a href="/services/custom" class="font-semibold text-gray-900">
              Custom
              <span class="absolute inset-0"></span>
            </a>
            <p class="mt-1 text-gray-600">
              Don't see what you're looking for? Reach out anyway and let's see
              if we can still partner.
            </p>
          </div>
        </div>
      </div>
      <div class="grid divide-x divide-gray-900/5 bg-gray-50">
        <a
          href="mailto:john@waysoftware.dev"
        ...
        >
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="size-6 h-5 w-5 flex-none text-gray-400"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
